...
while cont == "y":
    ...
    if calculation == "s":
        ...
        if function == 1:
            print(str(integration(f1, lower, upper, rectOrTrap)))
        elif function == 2:
            print(str(integration(f2, lower, upper, rectOrTrap)))
        elif function == 3:
            print(str(integration(f3, lower, upper, rectOrTrap)))
